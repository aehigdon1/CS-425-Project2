...
<html>
    ...
    <body>
        ...
        <p><span class="register"; style="font-weight: normal; font-family: times new roman; font-size: 20px; margin-left: 0.75em;">Registration Page</span></p>
        <p style="background-color: #D30000; padding: 2px; margin-left: 1em; margin-right: 1em;"><span class="small_red_line";></span></p>
        
        
        <label for="register">Enter CRN: </label>
